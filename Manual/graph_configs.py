...
CONFIG_13 = {
    ...
    'edges': [
        ...
        ('B_0_0', 'B_1_0', 5),
        ('B_0_1', 'B_1_1', 5),
        ('B_0_2', 'B_1_2', 5),  # Middle bridge has higher capacity
        ('B_0_3', 'B_1_3', 5),
        ('B_0_4', 'B_1_4', 5),
...
# Configuration 14: Grid Network with Full Bridges and Full Forward and Backward Connections and diagonal bridges
CONFIG_14 = {
    'name': 'Extended Grid Network with Full Bridges',
    'edges': [
        # Connect super source to all source nodes
...
ALL_CONFIGS = [CONFIG_1, CONFIG_2, CONFIG_3, CONFIG_4, CONFIG_5, CONFIG_6, CONFIG_7, CONFIG_8, CONFIG_9, CONFIG_10, CONFIG_11, CONFIG_12, CONFIG_13, CONFIG_14]
